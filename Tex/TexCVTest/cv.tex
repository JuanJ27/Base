...
\begin{document}
    ...
    \section{Profile}
    \begin{onecolentry}
        Enthusiastic physics student pursuing a bachelor’s degree in physics, interested in the DESY Summer Student Programme 2025. Hands-on experience in experimental and computational techniques, including data analysis, software development (C++, Python), and collaborative research in fundamental science projects.
    \end{onecolentry}
